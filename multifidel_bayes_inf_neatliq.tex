    ...
    \begin{itemize}
    	...
    	\begin{itemize}
            ...
            \begin{itemize}
                ...
                \end{itemize}
                \item Formalizing expressions for my specific problem (which variables are which and what
                      exactly do the covariances refer to).
            \end{itemize}
    	\end{itemize}
...
\begin{itemize}
	...
	%    \end{itemize}        
	%\end{itemize}
    %\item \textbf{Hypothesis: Different sampling algorithms will affect the speed of convergence to our final force field as well final distribution of parameters sampled.}
